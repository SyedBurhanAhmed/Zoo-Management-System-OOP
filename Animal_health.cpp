...
Animal_health::Animal_health(string id, string name, int off_spring, int cell_id, char gender, int age, float weight, string group,string l,
                             string sta, string k, string diet, string c, string sup,string h,string s,const date& d,string a)
    : Animal(id, name, off_spring, cell_id, gender, age, weight, group,l)
{
    this->set_status(sta);
    this->set_keeper(k);
    this->set_diet(diet);
