...
int main()
{
    ...
    animals[0] = new Animal_health("lim4_1", "Lion", 2, 1, 'M', 5, 10.0, "Mammal", "Zone A",
                                   "Sick", "Ahmed", "Meat", "Carnivore", "Adequate",
                                   "Kenya", "Endangered", date(1, 1, 2022), "Lion Enclosure");
    animal_count++;
    animals[1] = new Animal_health("ele4_2", "Elephant", 3, 2, 'F', 4, 12.5, "Mammal", "Zone A",
                                   "Fit", "Salman", "Diet 2", "Herbivore", "Low",
                                   "Srilanka", "Common", date(2, 2, 2023), "Elephant Enclosure");
    animal_count++;
    animals[2] = new Animal_health("tig4_3", "Tiger", 1, 3, 'M', 6, 15.0, "Mammal", "Zone A",
                                   "Fit", "Umer", "Meat", "Carnivore", "Low",
                                   "Nepal", "Endangered", date(3, 3, 2021), "Tiger Enclosure");
    animal_count++;
    animals[3] = new Animal_health("gir4_4", "Giraffe", 2, 4, 'F', 3, 9.5, "Mammal", "Zone A",
                                   "Fit", "Ali", "Leave", "Herbivore", "Adequate",
                                   "Namibia", "Common", date(4, 4, 2020), "Giraffe Enclosure");
    animal_count++;
    animals[4] = new Animal_health("zeb4_5", "Zebra", 3, 5, 'M', 4, 11.0, "Mammal", "Zone A",
                                   "Sick", "Ahmed", "Grass", "Herbivore", "Low",
                                   "Zambia", "Endangered", date(5, 5, 2019), "Zebra Enclosure");
    animal_count++;
    ...
    do {//do while loop for displaying options
        ...
        switch (choice) {
            ...
            case 4:
                ...
                display_animal(animals,location,MAX_ANIMALS);
                break;
            case 5:
